        ...
        <div id="content" class="flex gap-6 p-6 mt-16 w-[83.2%]">
            <div class="w-full">    
                <div class="container mx-auto px-0 py-0 w-[100%]">
                    <div class="overflow-x-auto bg-white border border-gray-200 rounded-lg shadow-md h-[595px]">
                        <table id="dataTable" class="min-w-full">
                            <thead class="bg-white">
                                <tr>
                                    <th class="py-4 px-4 text-center font-bold text-gray-600 border-b">No</th>
                                    <th class="py-4 px-4 text-center font-bold text-gray-600 border-b">Tanggal</th>
                                    <th class="py-4 px-4 text-center font-bold text-gray-600 border-b">Gaji</th>
            ...
            <div class="w-1/1 bg-white border border-gray-200 rounded-lg shadow-md p-4 w-[442px] h-[595px]">
