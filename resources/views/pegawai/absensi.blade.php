                        ...
                        <table id="dataTable" class="min-w-full">
                            <thead class="bg-white">
                                <tr>
                                    ...
                                    <th class="py-4 px-6 text-center font-bold text-gray-600 border-b">Kehadiran</th>
                                </tr>
                            </thead>
                            <tbody id="tableBody">
                    ...
                    const row = `
                        <tr class="border-b">
                            ...
                            <td class="border px-4 py-2 text-sm">
                                <button onclick="window.location.href='/absensi/rincian'" class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium py-1 px-3 rounded">
                                    Lihat
                                </button>
                            </td>
                        </tr>
