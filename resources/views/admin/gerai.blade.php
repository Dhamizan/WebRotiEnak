    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
                        ...
                        <table id="dataTable" class="min-w-full">
                            <thead class="bg-white">
                                <tr>
                                    ...
                                    <th class="py-4 px-6 text-center font-bold text-gray-600 border-b">Alamat</th>
                                    <th class="py-4 px-6 text-center font-bold text-gray-600 border-b">Kepala Toko</th>
        ...
        <div id="modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 hidden z-50 ">
            <div class="bg-white p-6 rounded-lg shadow-lg w-96">
                ...
                <form>
                    <div class="mb-3">
                        <label class="block text-gray-700">Nama Gerai</label>
