                        ...
                        <table id="dataTable" class="min-w-full">
                            <thead class="bg-white">
                                <tr>
                                    ...
                                    <th class="py-4 px-6 text-center font-bold text-gray-600 border-b">Nama</th>
                                    <th class="py-4 px-6 text-center font-bold text-gray-600 border-b">Outlet</th>
                                    <th class="py-4 px-6 text-center font-bold text-gray-600 border-b">Posisi</th>
                                    <th class="py-4 px-6 text-center font-bold text-gray-600 border-b">Lihat</th>
                                </tr>
                            </thead>
                            <tbody id="tableBody">
        ...
        <div id="modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 hidden z-50 ">
            <div class="bg-white p-6 rounded-lg shadow-lg w-96">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        <label class="block text-gray-700">Alamat</label>
                        <select class="w-full p-2 border rounded-lg bg-gray-100" name="" id="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="role" value="Pegawai" readonly class="w-full p-2 border rounded-lg bg-gray-100 text-gray-500 cursor-not-allowed">
                    </div>
