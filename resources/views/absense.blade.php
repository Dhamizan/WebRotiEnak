...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div id="content" class="flex-1 p-6 mt-20 ml-64 overflow-x-auto">
        ...
        <h1 class="text-3xl font-bold">Selamat Datang di Absensi!</h1>
        
        <div class="space-y-4 w-full mt-12 overflow-x-auto">
        <div class="relative">
        <input type="text" placeholder="12 Desember 2024" 
    ...
    <thead>
        <tr>
            ...
            <th class="py-4 px-6 bg-white font-bold uppercase text-sm text-gray-600 border-b">
            <div class="flex items-center space-x-4">Jam Masuk</div></th>
            <th class="py-4 px-6 bg-white font-bold uppercase text-sm text-gray-600 border-b">
                <div class="flex items-center space-x-4">Jam Keluar</div></th>
            <th class="py-4 px-6 bg-white font-bold uppercase text-sm text-gray-600 border-b">
            <div class="flex items-center space-x-4">Jam Kerja</div></th>
            <th class="py-4 px-6 bg-white font-bold uppercase text-sm text-gray-600 border-b">
            <div class="flex items-center space-x-4">Status</div></th>
        </tr>
    </thead>
    <tbody id="tableBody">
        <tr>
            ...
            <td class="py-4 px-6 bg-white">
                <span class="px-3 py-1 text-xs font-bold text-white rounded-full bg-red-500">Belum Hadir</span>
            </td>
        </tr>
        <tr>
            ...
            <td class="py-4 px-6 bg-white">07:56:30</td>
            <td class="py-4 px-6 bg-white">
                <span class="px-3 py-1 text-xs font-bold text-white rounded-full bg-yellow-500">Kerja</span>
            </td>
        </tr>
        <tr>
            ...
            <td class="py-4 px-6 bg-white">07:56:30</td>
            <td class="py-4 px-6 bg-white">
                <span class="px-3 py-1 text-xs font-bold text-white rounded-full bg-green-500">Hadir</span>
            </td>
        </tr>
    </tbody>
</table>
